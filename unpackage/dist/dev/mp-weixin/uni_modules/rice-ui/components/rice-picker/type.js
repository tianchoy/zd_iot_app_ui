...
class PickerCascadeState extends common_vendor.UTS.UTSType {
  static get$UTSMetadata$() {
    return {
      kind: 2,
      get fields() {
        return {
          columns: { type: common_vendor.UTS.UTSType.withGenerics(Array, [common_vendor.UTS.UTSType.withGenerics(Array, [PickerOption])]), optional: false },
          selectedIndex: { type: common_vendor.UTS.UTSType.withGenerics(Array, [Number]), optional: false },
          selectedValues: { type: common_vendor.UTS.UTSType.withGenerics(Array, ["Unknown"]), optional: false }
        };
      },
      name: "PickerCascadeState"
    };
  }
  constructor(options, metadata = PickerCascadeState.get$UTSMetadata$(), isJSONParse = false) {
    super();
    this.__props__ = common_vendor.UTS.UTSType.initProps(options, metadata, isJSONParse);
