  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        d: common_vendor.o(changeTab, "c8"),
        ...
        F: common_vendor.o(handleClick, "a2"),
        ...
        O: common_vendor.o(handleUnbind, "56"),
        P: common_vendor.p({
          type: "error",
          ["plain-fill"]: true,
          text: "解绑卡片",
        ...
        S: common_vendor.o(handleBindCard, "e1"),
        T: common_vendor.p({
          height: "100rpx",
          bold: true,
          customStyle: {
        ...
        U: common_vendor.o(handleRecharge, "d5"),
        V: common_vendor.p({
          height: "100rpx",
          type: "primary",
          color: "#1989fa",
