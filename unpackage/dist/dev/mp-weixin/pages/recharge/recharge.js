...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const toPay = (data = null) => {
      ...
      if (res.payWxType == "wechat_pay") {
        common_vendor.index.requestPayment({
          ...
          success: (res2) => {
            common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:285", "支付成功", res2);
        ...
        if (res.payWxClass == "0") {
          common_vendor.index.requestPayment({
            ...
            success: function(res2) {
              common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:302", "支付成功", res2);
              common_vendor.index.hideLoading();
            },
            fail: function(err) {
              common_vendor.index.hideLoading();
          ...
          common_vendor.wx$1.navigateToMiniProgram(new common_vendor.UTSJSONObject({
            ...
            extraData: param,
            success(res2 = null) {
              common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:330", "支付成功0000:", res2);
            },
            fail(res2 = null) {
              common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:333", "支付失败:", res2);
              common_vendor.index.hideLoading();
            }
          }));
        }
    ...
    const handleConfirmPayment = (e = null) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/recharge/recharge.uvue:369", "添加订单失败:", error);
          common_vendor.index.hideLoading();
          common_vendor.index.showToast({
            title: "添加订单失败",
            icon: "none"
    ...
    const onPopupClose = () => {
      common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:379", "弹窗关闭");
    };
    const goBack = () => {
    ...
    const getCardDetail = (cardNumber2, country2) => {
      return common_vendor.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          common_vendor.index.__f__("error", "at pages/recharge/recharge.uvue:415", "获取卡片详情失败:", error);
          common_vendor.index.showToast({
            title: "获取卡片信息失败",
            icon: "none"
          });
    ...
    common_vendor.onLoad((options) => {
      common_vendor.index.__f__("log", "at pages/recharge/recharge.uvue:426", "options:", options);
      const opt = options;
      ...
      if (cardNumberValue) {
        ...
        common_vendor.index.__f__("error", "at pages/recharge/recharge.uvue:436", "未获取到卡片号码");
        common_vendor.index.showToast({
          title: "卡片号码不存在",
          icon: "none"
        });
    ...
    return (_ctx, _cache) => {
      ...
      const __returned__ = common_vendor.e({
        ...
        e: (_c = cardDetail.value) == null ? void 0 : _c.pkgName
      }, ((_d = cardDetail.value) == null ? void 0 : _d.pkgName) ? {
        f: common_vendor.t(((_e = cardDetail.value) == null ? void 0 : _e.pkgName) || "未知")
      } : {}, {
        g: common_vendor.t(((_f = cardDetail.value) == null ? void 0 : _f.usedFlow) || 0),
        h: common_vendor.t(((_g = cardDetail.value) == null ? void 0 : _g.unUsedFlow) || 0),
        i: common_vendor.t(((_h = cardDetail.value) == null ? void 0 : _h.pkgFlow) || 0),
        j: common_vendor.p({
          percentage: percentage.value,
          ["show-text"]: true,
          class: "data-v-722cdacb"
        }),
        k: common_vendor.o(toMyPackage, "09"),
        l: common_vendor.p({
          class: "btn mr-24 data-v-722cdacb"
        }),
        m: common_vendor.o(toOrderRecord, "55"),
        n: common_vendor.p({
          class: "btn data-v-722cdacb"
        }),
        o: common_vendor.o(changeTab, "6a"),
        ...
        x: `${_ctx.u_s_b_h}px`,
        y: `${_ctx.u_s_a_i_b}px`,
        z: common_vendor.o(handleCancelPayment, "70"),
        A: common_vendor.o(handleConfirmPayment, "8c"),
        B: common_vendor.p({
          ...
          pkgType: (_m = currentPackage.value) == null ? void 0 : _m.pkgType,
          class: "data-v-722cdacb"
        }),
        C: common_vendor.o(onPopupClose, "84"),
        ...
        G: common_vendor.o(choosePayment, "ec"),
        H: common_vendor.p({
          type: "primary",
          width: "300rpx",
          height: "110rpx",
