...
import {queryOrderList} from '@/api/http'
	...
	// Tab 列表
	type OrderStatusTab = { __$originalPosition?: UTSSourceMapPosition<"OrderStatusTab", "pages/orderRecord/orderRecord.uvue", 76, 7>;
		name: OrderStatus,
		value: string
	}
