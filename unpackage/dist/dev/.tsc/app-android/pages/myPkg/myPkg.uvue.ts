  ...
  return _cE(Fragment, null, [
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("view", _uM({ class: "card-info" }), [
        ...
        _cE("view", _uM({ class: "info-value" }), _tD(card_number.value), 1 /* TEXT */)
      ]),
              ...
              _cE("view", _uM({ class: "package-metrics" }), [
                ...
                isTrue(item.usedFlow)
                  ? _cE("view", _uM({
                      ...
                      _cE("text", _uM({ class: "metric-label" }), "已用"),
