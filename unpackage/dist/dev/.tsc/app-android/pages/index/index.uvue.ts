  ...
  return _cE("view", _uM({ class: "container" }), [
    ...
    _cE("view", _uM({ class: "card-box" }), [
      ...
      _cE("view", _uM({ class: "search-value" }), [
        _cE("input", _uM({
          modelValue: unref(card_number),
          onInput: ($event: UniInputEvent) => {trySetRefValue(card_number, $event.detail.value)},
    ...
    _cE("view", _uM({ class: "card-box" }), [
      _cE("view", _uM({ class: "card-label" }), [
        _cE("text", null, "最近常用卡片"),
        _cE("text", _uM({ class: "view-all" }), "查看全部")
      ]),
