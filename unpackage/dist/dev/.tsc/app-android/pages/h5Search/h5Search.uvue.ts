...
const _component_rice_popup = resolveEasyComponent("rice-popup",_easycom_rice_popup)
  ...
  return _cE(Fragment, null, [
    ...
    _cV(_component_rice_popup, _uM({
      ...
      "onUpdate:show": $event => {(showCountryPopup).value = $event},
      position: "bottom",
