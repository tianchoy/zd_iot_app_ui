  ...
  return _cE(Fragment, null, [
    ...
    _cE("view", _uM({ class: "container" }), [
      _cE("view", _uM({ class: "card-box mb-24" }), [
        ...
        _cE("view", _uM({ class: "search-value mt-24 mb-24" }), [
          _cE("input", _uM({
