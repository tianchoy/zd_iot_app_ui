...
const __sfc__ = defineComponent({
	...
	computed: {
		...
		wrapStyle(): UTSJSONObject {
			const st = { __$originalPosition: new UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 191, 10), } as UTSJSONObject
		...
		mainStyle(): UTSJSONObject {
			const st = { __$originalPosition: new UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 204, 10), } as UTSJSONObject
	...
	methods: {
		...
		subStyle(btn: FabBtn): UTSJSONObject {
			const st = { __$originalPosition: new UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 436, 10), } as UTSJSONObject
