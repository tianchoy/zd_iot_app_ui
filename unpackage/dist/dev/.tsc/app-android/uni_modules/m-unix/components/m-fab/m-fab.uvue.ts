...
const __sfc__ = defineComponent({
	...
	data() {
		return {
			...
			clickTimer: null as any,      // 点击延迟定时器
		}
	},
	computed: {
	...
	methods: {
		...
		subStyle(btn: FabBtn): UTSJSONObject {
			const st = { __$originalPosition: new UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-fab/m-fab.uvue", 486, 10), } as UTSJSONObject
