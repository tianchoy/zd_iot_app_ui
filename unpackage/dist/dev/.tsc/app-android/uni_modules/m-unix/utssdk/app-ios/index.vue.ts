...
//
  ...
  export default {
    ...
    methods: {
      ...
      doSomething(paramA : string) {
        // 这是组件的自定义方法
        __f__('log','at uni_modules/m-unix/utssdk/app-ios/index.vue:91',paramA, 'this is in uts-button component')
      },
  ...
  class ButtonClickListsner {
    ...
    @objc buttonClickAction() {
      __f__('log','at uni_modules/m-unix/utssdk/app-ios/index.vue:197',"按钮被点击")
      // 发送事件
