...
export function getTenantInfo(tenantId: string, withToken: boolean = true): Promise<ApiResponse<TenantInfoData>> {
  ...
  // 其他平台默认使用H5配置
  const url = (ApiUrl.getTenantPageConfigH as string) + '/' + tenantId
