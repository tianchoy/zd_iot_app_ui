...
function storageSet(key: string, value: any): void {
	try {
		...
		__f__('error','at api/Storage.uts:41','storage set error', e)
	}
}
...
function storageRemove(key: string): void {
	try {
		...
		__f__('error','at api/Storage.uts:49','storage remove error', e)
	}
}
...
function storageClear(): void {
	try {
		...
		__f__('error','at api/Storage.uts:57','storage clear error', e)
	}
}
