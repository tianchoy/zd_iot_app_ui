...
open class UtsButtonComponent : UTSComponent<Button> {
    ...
    open fun doSomething(param: String) {
        console.log(param, " at uni_modules/m-unix/utssdk/app-android/index.vue:91")
    }
...
open class ButtonClickListener : View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        console.log("按钮被点击", " at uni_modules/m-unix/utssdk/app-android/index.vue:186")
