...
open class GenUniModulesMUnixComponentsMTabsMTabs : VueComponent {
    ...
    open var clickTimer: Number by `$data`
    ...
    override fun data(): Map<String, Any?> {
        return _uM("expanded" to false as Boolean, "winW" to 0 as Number, "winH" to 0 as Number, "dragLeftPx" to 0 as Number, "dragTopPx" to 0 as Number, "dragReady" to false as Boolean, "wrapWpx" to 0 as Number, "wrapHpx" to 0 as Number, "touchStartX" to 0 as Number, "touchStartY" to 0 as Number, "touchStartLeft" to 0 as Number, "touchStartTop" to 0 as Number, "isDragging" to false as Boolean, "hasMoved" to false as Boolean, "moveDistance" to 0 as Number, "clickTimer" to -1 as Number, "safeBtnList" to computed<UTSArray<UTSJSONObject>>(fun(): UTSArray<UTSJSONObject> {
            ...
            val st: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 191, 10))
            ...
            val st: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 204, 10))
    ...
    open fun gen_getTouchPoint_fn(e: Any): TouchPoint__1? {
        ...
        return TouchPoint__1(if (x == null) {
            0
        } else {
            x
        }
    ...
    open fun gen_subText_fn(btn: FabBtn__1): String {
    ...
    open fun gen_subImg_fn(btn: FabBtn__1): String {
    ...
    open fun gen_subColor_fn(btn: FabBtn__1): String {
        val c = btn["color"]
        return if (c == null) {
            "#ffffff"
        } else {
    ...
    open fun gen_subFontSize_fn(btn: FabBtn__1): Number {
        val fs = btn["fontSize"]
        if (fs != null) {
    ...
    open fun gen_subStyle_fn(btn: FabBtn__1): UTSJSONObject {
        val st: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("st", "uni_modules/m-unix/components/m-tabs/m-tabs.uvue", 436, 10))
        val bg = btn["bgColor"]
