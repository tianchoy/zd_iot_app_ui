...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "127.0.0.1,192.168.1.95"
    val port: String = "8090"
    val id: String = "app-android_TqdH14"
    if (hosts == "" || port == "" || id == "") {
...
val ENV = "dev"
val API_CONFIG: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("API_CONFIG", "common/config.uts", 36, 7), "dev" to _uO("baseUrl" to "http://192.168.0.4:8081", "timeout" to 30000), "prod" to _uO("baseUrl" to "https://cmpapp.zdiot.cn/prod-api", "timeout" to 30000))
...
val runBlock4 = run {
    console.log("配置注入成功:", injectedConfig.baseUrl, " at utils/inject-m-unix.uts:30")
}
...
open class CardItem (
    ...
    @JsonNotNull
    open var usedTraffic: String,
    @JsonNotNull
    open var totalTraffic: String,
    @JsonNotNull
    open var currentCycle: String,
) : UTSObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CardItem", "api/types.uts", 42, 13)
    }
}
open class QueryCardListData (
    @JsonNotNull
    open var list: UTSArray<CardItem>,
) : UTSObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("QueryCardListData", "api/types.uts", 55, 13)
    }
}
open class CardDetail (
    @JsonNotNull
    open var currentPeriodEndTime: String,
    @JsonNotNull
    open var currentPeriodStartTime: String,
    @JsonNotNull
    open var effectiveTime: String,
    @JsonNotNull
    open var expirationTime: String,
    @JsonNotNull
    open var pkgFlow: String,
    @JsonNotNull
    ...
    open var status: String,
    @JsonNotNull
    open var totalPeriod: String,
    @JsonNotNull
    open var unUsedFlow: String,
    @JsonNotNull
    open var usedFlow: String,
    @JsonNotNull
    open var usedPeriod: String,
    @JsonNotNull
    open var isBind: Boolean = false,
) : UTSReactiveObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CardDetail", "api/types.uts", 58, 13)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
        return CardDetailReactiveObject(this, __v_isReadonly, __v_isShallow, __v_skip)
    }
}
class CardDetailReactiveObject : CardDetail, IUTSReactive<CardDetail> {
    override var __v_raw: CardDetail
    override var __v_isReadonly: Boolean
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: CardDetail, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(currentPeriodEndTime = __v_raw.currentPeriodEndTime, currentPeriodStartTime = __v_raw.currentPeriodStartTime, effectiveTime = __v_raw.effectiveTime, expirationTime = __v_raw.expirationTime, pkgFlow = __v_raw.pkgFlow, pkgName = __v_raw.pkgName, rechargeNo = __v_raw.rechargeNo, status = __v_raw.status, totalPeriod = __v_raw.totalPeriod, unUsedFlow = __v_raw.unUsedFlow, usedFlow = __v_raw.usedFlow, usedPeriod = __v_raw.usedPeriod, isBind = __v_raw.isBind) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    }
    override fun __v_clone(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): CardDetailReactiveObject {
        return CardDetailReactiveObject(this.__v_raw, __v_isReadonly, __v_isShallow, __v_skip)
    }
...
open class BindCard (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("BindCard", "api/types.uts", 74, 13)
    }
}
open class PkgInfoListParams (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PkgInfoListParams", "api/types.uts", 78, 13)
    }
}
open class Config (
    @JsonNotNull
...
open class RequestOptions__1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("RequestOptions", "api/Request.uts", 21, 13)
    }
}
...
val DEFAULT_LOGIN_PAGE = "/pages/login/login"
...
fun buildQueryString(data: UTSJSONObject): String {
    ...
    for(key in resolveUTSKeyIterator(data)){
        ...
        if (value != null && value !== "") {
            ...
            parts.push(key + "=" + UTSAndroid.consoleDebugError(encodeURIComponent(strValue), " at api/Request.uts:97"))
        }
    }
...
fun <T> request(options: RequestOptions__1): UTSPromise<ApiResponse<T>> {
    ...
    val reqHeader: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("reqHeader", "api/Request.uts", 201, 11), "Content-Type" to "application/json", "Accept" to "application/json", "Content-Language" to DEFAULT_LANGUAGE, "clientId" to config.api.auth.clientId)
    if (withToken) {
        val token = getToken()
        if (token != "") {
...
val http: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("http", "api/Request.uts", 356, 14), "get" to fun(url: String, data: UTSJSONObject?, options: RequestOptions__1?): UTSPromise<ApiResponse<Any>> {
...
fun __uts_large_ApiUrl_fill_fill_1(__obj: UTSJSONObject): Unit {
    ...
    __obj["userBindCard"] = "/system/appUserCard/bind"
}
fun __uts_large_ApiUrl_build_0(): UTSJSONObject {
    val __obj: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("__obj", "api/url.uts", 24, 11))
...
fun queryCardList(params: QueryCardListParams, withToken: Boolean = true): UTSPromise<ApiResponse<QueryCardListData>> {
    val data: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("data", "api/http.uts", 55, 11), "rechargeNo" to params.rechargeNo, "status" to params.status, "isSort" to params.isSort)
    return request<QueryCardListData>(RequestOptions__1(url = ApiUrl["queryCardList"] as String, method = "GET", data = data, withToken = withToken))
}
...
fun queryCardDetail(id: String, countryCode: String?, withToken: Boolean = true): UTSPromise<ApiResponse<CardDetail>> {
    val url = (ApiUrl["queryCardDetail"] as String) + id + "/" + countryCode
    return request<CardDetail>(RequestOptions__1(url = url, method = "GET", withToken = withToken))
}
fun userBindCard(data: BindCard, withToken: Boolean = true): UTSPromise<ApiResponse<Any>> {
    val body: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("body", "api/http.uts", 87, 11), "rechargeNo" to data.rechargeNo)
...
fun queryPkgInfoList(data: PkgInfoListParams, withToken: Boolean = true): UTSPromise<ApiResponse<Any>> {
    ...
    val body: UTSJSONObject = _uO("__\$originalPosition" to UTSSourceMapPosition("body", "api/http.uts", 101, 11), "rechargeNo" to data.rechargeNo)
    return request<Any>(RequestOptions__1(url = url, method = "GET", data = body, withToken = withToken))
}
open class TabItem (
    @JsonNotNull
    open var name: String,
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("TabItem", "pages/card/card.uvue", 92, 6)
    }
}
...
open class TabItem__1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("TabItem", "pages/recharge/recharge.uvue", 133, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class PackageItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PackageItem", "pages/recharge/recharge.uvue", 138, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class ChangeTabEvent (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ChangeTabEvent", "pages/recharge/recharge.uvue", 148, 7)
    }
}
...
open class CardDetailTabItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CardDetailTabItem", "pages/cardDetail/cardDetail.uvue", 96, 7)
    }
}
open class CardDetailTabEvent (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CardDetailTabEvent", "pages/cardDetail/cardDetail.uvue", 100, 7)
    }
}
typealias PackageStatus = String
open class PackageItem__1 (
    @JsonNotNull
    open var name: String,
    @JsonNotNull
    open var status: PackageStatus,
    @JsonNotNull
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PackageItem", "pages/cardDetail/cardDetail.uvue", 131, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
        return PackageItem__1ReactiveObject(this, __v_isReadonly, __v_isShallow, __v_skip)
    }
}
class PackageItem__1ReactiveObject : PackageItem__1, IUTSReactive<PackageItem__1> {
    override var __v_raw: PackageItem__1
    override var __v_isReadonly: Boolean
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: PackageItem__1, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(name = __v_raw.name, status = __v_raw.status, statusText = __v_raw.statusText, tagType = __v_raw.tagType, startTime = __v_raw.startTime, totalFlow = __v_raw.totalFlow, usedFlow = __v_raw.usedFlow, leftFlow = __v_raw.leftFlow) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    }
    override fun __v_clone(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): PackageItem__1ReactiveObject {
        return PackageItem__1ReactiveObject(this.__v_raw, __v_isReadonly, __v_isShallow, __v_skip)
    }
    override var name: String
        get() {
            return _tRG(__v_raw, "name", __v_raw.name, __v_isReadonly, __v_isShallow)
    ...
    override var status: PackageStatus
        get() {
            return _tRG(__v_raw, "status", __v_raw.status, __v_isReadonly, __v_isShallow)
        }
        set(value) {
...
open class OrderStatusTab (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("OrderStatusTab", "pages/myOrder/myOrder.uvue", 96, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
class OrderStatusTabReactiveObject : OrderStatusTab, IUTSReactive<OrderStatusTab> {
    ...
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: OrderStatusTab, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(name = __v_raw.name) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
...
typealias PackageStatus__1 = String
interface PackageTab {
    var name: PackageStatus__1
}
