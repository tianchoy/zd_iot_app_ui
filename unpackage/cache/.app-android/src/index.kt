...
open class LoginData (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("LoginData", "api/http.uts", 6, 13)
    }
}
...
typealias FabBtn__1 = UTSJSONObject
open class TouchPoint__1 {
    open lateinit var x: Number
    open lateinit var y: Number
    constructor(x: Number, y: Number){
        this.x = x
...
class TabItemReactiveObject : TabItem, IUTSReactive<TabItem> {
    ...
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: TabItem, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(name = __v_raw.name) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
