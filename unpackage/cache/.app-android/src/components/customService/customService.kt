    ...
    companion object {
        ...
        var setup: (__props: GenComponentsCustomServiceCustomService) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cV(_component_rice_float_fab, _uM("default-position" to "bottom-right", "icon" to "chat-fill", "width" to "80rpx", "height" to "80rpx", "icon-size" to "50rpx", "gap-bottom" to "200rpx", "gap-right" to "50rpx", "onClick" to handleClick))
            }
        }
