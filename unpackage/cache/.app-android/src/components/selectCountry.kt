...
open class GenComponentsSelectCountry : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsSelectCountry, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "search-select"), _uA(
                    ...
                    _cE("scroll-view", _uM("class" to "options-list", "scroll-y" to "", "enhanced" to true, "show-scrollbar" to false, "style" to _nS(_uM("maxHeight" to _ctx.maxHeight, "minHeight" to _ctx.minHeight))), _uA(
        ...
        ), "valueKey" to _uM("type" to "String", "default" to "value"), "labelKey" to _uM("type" to "String", "default" to "label"), "searchPlaceholder" to _uM("type" to "String", "default" to "请输入关键词搜索"), "emptyText" to _uM("type" to "String", "default" to "暂无数据"), "maxHeight" to _uM("type" to "String", "default" to "50%"), "minHeight" to _uM("type" to "String", "default" to "50%")))
