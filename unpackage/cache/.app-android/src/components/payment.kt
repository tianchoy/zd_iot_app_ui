...
open class GenComponentsPayment : VueComponent {
    ...
    open var pkgType: String? by `$props`
    companion object {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "payment-content"), _uA(
                    _cE("view", _uM("class" to "payment-info"), _uA(
                        ...
                        if (isTrue(props.cardNumber)) {
                            _cE("view", _uM("key" to 0, "class" to "info-item"), _uA(
                                _cE("text", _uM("class" to "item-label"), "卡号"),
                                _cE("text", _uM("class" to "item-value"), _tD(props.cardNumber), 1)
                            ))
                        } else {
                            _cC("v-if", true)
                        }
                        ,
                        if (isTrue(props.productName)) {
                            _cE("view", _uM("key" to 1, "class" to "info-item"), _uA(
                                _cE("text", _uM("class" to "item-label"), "商品"),
                                _cE("text", _uM("class" to "item-value"), _tD(props.productName), 1)
                            ))
                        } else {
                            _cC("v-if", true)
                        }
                        ,
                        if (isTrue(props.traffic)) {
                            _cE("view", _uM("key" to 2, "class" to "info-item"), _uA(
                                _cE("text", _uM("class" to "item-label"), "流量"),
                                _cE("text", _uM("class" to "item-value"), _tD(props.traffic), 1)
                            ))
                        } else {
                            _cC("v-if", true)
                        }
                        ,
                        if (isTrue(props.validityPeriod)) {
                            _cE("view", _uM("key" to 3, "class" to "info-item"), _uA(
                                _cE("text", _uM("class" to "item-label"), "有效期"),
                                _cE("text", _uM("class" to "item-value"), _tD(props.validityPeriod) + _tD(if (props?.pkgType == "1") {
                                    "天"
                                } else {
                                    "个月"
                                }), 1)
