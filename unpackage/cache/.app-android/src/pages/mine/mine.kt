                        ...
                        _cE("view", _uM("class" to "card-info mb-24"), _uA(
                            _cE("view", _uM("class" to "persion-card"), _uA(
                                _cE("view", _uM("class" to "persion-card-item", "onClick" to fun(){
                                    ...
                                    _cE("text", _uM("class" to "persion-card-item-content"), _tD(if (unref(cardListSum).all != null) {
                                        unref(cardListSum).all
                                    } else {
                                        0
                                    }
                                    ), 1)
                                ...
                                _cE("view", _uM("class" to "persion-card-item", "onClick" to fun(){
                                    ...
                                    _cE("text", _uM("class" to "persion-card-item-content"), _tD(if (unref(cardListSum).inUse != null) {
                                        unref(cardListSum).inUse
                                    } else {
                                        0
                                    }
                                    ), 1)
                                ...
                                _cE("view", _uM("class" to "persion-card-item", "onClick" to fun(){
                                    ...
                                    _cE("text", _uM("class" to "persion-card-item-content"), _tD(if (unref(cardListSum).inNotUse != null) {
                                        unref(cardListSum).inNotUse
                                    } else {
                                        0
                                    }
                                    ), 1)
