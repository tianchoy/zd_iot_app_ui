        ...
        var setup: (__props: GenPagesH5SearchH5Search) -> Any? = fun(__props): Any? {
            ...
            return fun(): Any? {
                ...
                return _cE(Fragment, null, _uA(
                            ...
                            _cE("view", _uM("class" to "card-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "search-value"), _uA(
                                    ...
                                    _cE("view", _uM("class" to "scan-btn", "onClick" to handleScan), _uA(
                                        _cV(_component_m_icon, _uM("name" to "scanning", "size" to "40rpx", "color" to "#666"))
                                    ))
                                )),
                    ...
                    _cV(_component_m_bottom_popup, _uM("show" to showCountryPopup.value, "height" to "75%", "radius" to true, "onClose" to onPopupClose), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                            _cE("view", _uM("class" to "popup-header"), _uA(
                                _cE("text", _uM("class" to "popup-title"), "选择国家/地区"),
                                _cE("view", _uM("class" to "popup-close", "onClick" to onPopupClose), _uA(
                                    _cV(_component_m_icon, _uM("name" to "close-bold", "size" to "40rpx"))
                                ))
                            )),
