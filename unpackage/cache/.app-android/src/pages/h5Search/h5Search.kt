...
open class GenPagesH5SearchH5Search : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesH5SearchH5Search) -> Any? = fun(__props): Any? {
            ...
            val cardNumber = ref<String>("gn20260603164757")
            ...
            val handleQuery = fun(){
                ...
                uni_navigateTo(NavigateToOptions(url = "/pages/recharge/recharge?cardNumber=" + cardNumber.value + "&country=" + selectedCountry.value + "&from=h5Search"))
            }
                ...
                return _cE(Fragment, null, _uA(
                    ...
                    , "position" to "bottom", "onClose" to onPopupClose), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                            ...
                            , "options" to countryOptions.value, "maxHeight" to "800rpx", "minHeight" to "800rpx", "search-placeholder" to "搜索国家/地区名称", "onChange" to onCountryChange), null, 8, _uA(
                                "modelValue",
                                "onUpdate:modelValue",
                                "options"
                            ))
