...
open class GenPagesRechargeRecharge : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesRechargeRecharge) -> Any? = fun(__props): Any? {
            ...
            val percentage = ref<Number>(60)
            val active = ref<Number>(0)
            val tabs = ref(_uA<TabItem__1>(TabItem__1(name = "套餐包"), TabItem__1(name = "加油包")))
            ...
            onLoad(fun(_options): UTSPromise<Unit> {
            ...
            return fun(): Any? {
                ...
                return _cE(Fragment, null, _uA(
                    ...
                    _cE("view", _uM("class" to "container"), _uA(
                        _cE("view", _uM("class" to "card-info"), _uA(
                            _cE("view", _uM("class" to "card-title"), _uA(
                                ...
                                _cV(_component_rice_tag, _uM("text" to "标签", "round" to true, "plain-fill" to "", "size" to "small", "type" to "success"))
                            )),
                            ...
                            _cE("view", _uM("class" to "flow-box"), _uA(
                                _cE("view", _uM("class" to "flow-label"), "流量信息"),
                        ...
                        _cE("view", _uM("class" to "pkg-box"), _uA(
                            ...
                            , "line-color" to "#ffffff", "list" to tabs.value, "line-width" to 0, "title-active-color" to "#2563eb", "onChange" to changeTab, "customStyle" to _uO("height" to "85rpx", "padding" to "10rpx", "border" to "1rpx solid #e5edf6")), null, 8, _uA(
                                "modelValue",
                                "onUpdate:modelValue",
                                "list"
                            )),
                    ...
                    , "position" to "bottom", "onClose" to _ctx.onPopupClose), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                    ...
                    _cE("view", _uM("class" to "bottom-box"), _uA(
                        ...
                        _cV(_component_rice_button, _uM("type" to "primary", "onClick" to choosePayment, "class" to "btn"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                "去支付"
                            )
                        }
