    ...
    companion object {
        ...
        var setup: (__props: GenPagesIndexIndex) -> Any? = fun(__props): Any? {
            ...
            val onScanResult = fun(data: Any){
                console.log("收到扫码结果:", data, " at pages/index/index.uvue:113")
            ...
            val cardType = fun(type: Number){
                console.log(type, " at pages/index/index.uvue:128")
                ...
                return _cE(Fragment, null, _uA(
                    ...
                    _cE("view", _uM("class" to "container"), _uA(
                        _cE("view", _uM("class" to "card-info"), _uA(
                            _cE("text", _uM("class" to "persion-name"), "Hi," + _tD(title.value), 1),
                        ...
                        _cE("view", _uM("class" to "card-box"), _uA(
                            ...
                            _cE("view", _uM("class" to "search-value"), _uA(
                                ...
                                _cV(_component_m_button, _uM("type" to "white", "plain" to true, "class" to "scan-btn", "width" to "90rpx", "onClick" to scanCode), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                    return _uA(
                                        _cV(_component_m_icon, _uM("name" to "scanning", "size" to "40rpx"))
                                    )
                                }
                                ), "_" to 1)),
                                _cV(_component_m_button, _uM("type" to "primary", "width" to "120rpx", "onClick" to handleQuery), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                    return _uA(
                                        "查询"
                                    )
                                }
                        ...
                        _cE("view", _uM("class" to "card-box"), _uA(
                            _cE("view", _uM("class" to "card-label"), _uA(
                            ...
                            _cE("view", _uM("class" to "card-list"), _uA(
                                _cE("view", _uM("class" to "card-item"), _uA(
                                    ...
                                    _cE("view", _uM("class" to "card-bottom"), _uA(
                                        ...
                                        _cV(_component_m_button, _uM("type" to "primary", "width" to "200rpx", "btnSize" to "mini", "size" to "25rpx", "shape" to "circle", "onClick" to goRecharge), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                "去充值"
                                            )
                                        }
